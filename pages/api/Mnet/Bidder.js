...
const response =await axios(`https://pubconsole.media.net/api/reports/v1/hourly-channel-wise?customer_guid=CF6FF673-0F7A-44BF-8F26-DC2CE5878740&customer_key=8CU2R1JY7&from_date=${yesterday}&to_date=${today}&page_size=300000`)
    ...
    // for(var i=0;i<mnet.length;i++){
        ...
        const client = await mClient()
                //    console.log("slope", slope)
                   ...
                   await client.db("LocalTest").collection("moment_mnet").deleteMany({name:"Bidder",delet_date:today});
